...
namespace SandbarWorkbench.ModelRuns
{
    public class ModelRunMaster : ModelRunBase
    {
        ...
        public void Update(ModelRunLocal localRun, ref MySqlTransaction dbTrans)
        {
            ...
            System.Diagnostics.Debug.Print("Master: {0}", dbCom.CommandText);
        ...
        public static ModelRunMaster Insert(ModelRunLocal localRun, ref MySqlTransaction dbTrans)
        {
            ...
            using (System.Data.SQLite.SQLiteConnection conLocal = new System.Data.SQLite.SQLiteConnection (DBCon.ConnectionStringMaster))
            {
                // Prepare the local command to insert child records
                dbCom = new MySqlCommand("INSERT INTO ModelResultsIncremental (RunID, SectionID, Elevation, Area, Volume) VALUES (@SectionID, @Elevation, @Area, @Volume)", dbTrans.Connection, dbTrans);
                ...
                conLocal.Open();
                System.Data.SQLite.SQLiteCommand comLocal = new System.Data.SQLite.SQLiteCommand("SELECT * FROM ModelResultsIncremental WHERE RunID = @RunID", conLocal);
