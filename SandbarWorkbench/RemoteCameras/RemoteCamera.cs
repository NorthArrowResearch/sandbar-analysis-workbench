                ...
                while (dbRead.Read())
                {
                    RemoteCamera theSite = new RemoteCamera(
                       ...
                       , (string)dbRead["CameraRiverBank"]
                        ...
                        , naru.db.sqlite.SQLiteHelpers.GetSafeValueNInt(ref dbRead, "SiteID")
                        , naru.db.sqlite.SQLiteHelpers.GetSafeValueStr(ref dbRead, "SiteCode5")
                        , naru.db.sqlite.SQLiteHelpers.GetSafeValueStr(ref dbRead, "NAUName")
                        , naru.db.sqlite.SQLiteHelpers.GetSafeValueBool(ref dbRead, "CurrentNPSPermit")
                        , naru.db.sqlite.SQLiteHelpers.GetSafeValueBool(ref dbRead, "HavePhotos")
                        , naru.db.sqlite.SQLiteHelpers.GetSafeValueStr(ref dbRead, "Subject")
                        , naru.db.sqlite.SQLiteHelpers.GetSafeValueStr(ref dbRead, "View")
                        , naru.db.sqlite.SQLiteHelpers.GetSafeValueStr(ref dbRead, "BestPhotoTime")
                        , naru.db.sqlite.SQLiteHelpers.GetSafeValueStr(ref dbRead, "BeginFilmRecord")
                        , naru.db.sqlite.SQLiteHelpers.GetSafeValueStr(ref dbRead, "EndFilmRecord")
                        , naru.db.sqlite.SQLiteHelpers.GetSafeValueStr(ref dbRead, "BeginDigitalRecord")
                        , naru.db.sqlite.SQLiteHelpers.GetSafeValueStr(ref dbRead, "EndDigitalRecord")
                        , naru.db.sqlite.SQLiteHelpers.GetSafeValueInt(ref dbRead, "CardTypeID")
                        , naru.db.sqlite.SQLiteHelpers.GetSafeValueStr(ref dbRead, "CardType")
